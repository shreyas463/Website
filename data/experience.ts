...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      "Designed and built a Java data-validation service for Walgreens' RxI pharmacy-inventory platform (8,000 stores, 9M+ daily patients), reconciling REST API contracts against Cosmos DB, Azure Storage, and Databricks output to catch schema and data mismatches before production, replacing 6 weeks of manual verification per cycle.",
      ...
      "Debug production issues across a high-availability distributed system, tracing anomalies through the API, storage, and Databricks layers to isolate where records diverged, then shipping both the fix and the guardrail that prevents recurrence, resolving 5–8 anomalies per month.",
    ],
    technologies: [
      "Java",
      "REST APIs",
  ...
  },
  {
    ...
    bullets: [
      "Architected a Java test-automation framework (Selenium, TestNG, Maven) on the Page Object Model with reusable utility libraries, automating 300+ end-to-end scenarios across DSCSA federal compliance, audits, returns, and stock management on handheld, desktop, and corporate platforms, raising automated coverage 65%.",
