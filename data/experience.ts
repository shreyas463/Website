...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      "Designed and built an automated data-validation service (Java) for Walgreens' RxI pharmacy-inventory platform (8,000 stores, 9M+ daily patients) — a pipeline that reconciles REST API contracts (Rest Assured, Swagger/OpenAPI) against Cosmos DB, Azure Storage, and Databricks outputs, surfacing schema and data discrepancies before they reach production and replacing 6 weeks of manual verification per cycle.",
      "Investigate and resolve production incidents across a regulated, high-availability distributed system serving 9M+ patients daily — tracing an anomaly through REST APIs, Cosmos DB, Azure Storage, and Databricks to isolate exactly where records diverged, then shipping both the fix and the guardrail against recurrence.",
      "Shipped 14+ releases in Agile sprints — refining requirements and user stories with product managers, participating in peer reviews of code and solution designs, and presenting release readiness to external clients and stakeholders.",
      "Own the build and deployment path for the service: built and maintained Jenkins and Azure DevOps CI/CD pipelines (Docker) that gate every build on 300+ automated Java scenarios spanning DSCSA federal compliance, audits, returns, and stock-management workflows — raising automated coverage 65% and blocking regressions before deploy.",
    ],
    technologies: [
      "Java",
      "Rest Assured",
    ...
    details: [
      ...
      "Day to day I work across the API, data, and pipeline layers to verify record accuracy between environments, and partner with developers, QA, product, and UAT stakeholders to investigate defects and validate business requirements ahead of each release.",
    ],
  },
  {
    id: "method-fullstack",
